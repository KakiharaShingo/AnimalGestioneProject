...
struct OtherRecord: Identifiable, Codable {
    var id: UUID
    var animalId: UUID
    var date: Date
    var title: String
    var nextScheduledDate: Date?
    var interval: Int? // 日数単位での間隔
    var notes: String?
    var color: Color?
    ...
    enum CodingKeys: String, CodingKey {
        case id, animalId, date, title, nextScheduledDate, interval, notes, colorHex
    }
    
    init(id: UUID, animalId: UUID, date: Date, title: String, nextScheduledDate: Date? = nil, interval: Int? = nil, notes: String? = nil, color: Color? = nil) {
        self.id = id
