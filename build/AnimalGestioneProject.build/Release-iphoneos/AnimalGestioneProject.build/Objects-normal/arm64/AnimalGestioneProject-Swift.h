...
#ifndef ANIMALGESTIONEPROJECT_SWIFT_H
#define ANIMALGESTIONEPROJECT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AnimalGestioneProject",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("AnimalEntity")
@interface AnimalEntity : NSManagedObject
...
@property (nonatomic, copy) NSString * _Nullable breed;
...
@property (nonatomic, copy) NSString * _Nullable species;
@property (nonatomic, strong) NSSet * _Nullable healthRecords;
@property (nonatomic, strong) NSSet * _Nullable physiologicalCycles;
@end

@class UIApplication;
SWIFT_CLASS("_TtC21AnimalGestioneProject11AppDelegate")
...
SWIFT_CLASS_NAMED("HealthRecordEntity")
@interface HealthRecordEntity : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@interface HealthRecordEntity (SWIFT_EXTENSION(AnimalGestioneProject))
@property (nonatomic) int16_t activityLevel;
@property (nonatomic) int16_t appetite;
@property (nonatomic, copy) NSDate * _Nullable date;
@property (nonatomic, copy) NSUUID * _Nullable id;
@property (nonatomic, copy) NSString * _Nullable notes;
@property (nonatomic) double temperature;
@property (nonatomic) double weight;
@property (nonatomic, strong) AnimalEntity * _Nullable animal;
@end

/// アプリ内課金を管理するクラス（StoreKit 2をラップしてレガシーコードとの互換性を提供）
SWIFT_CLASS("_TtC21AnimalGestioneProject20InAppPurchaseManager")
...
@class SKRequest;
@interface InAppPurchaseManager (SWIFT_EXTENSION(AnimalGestioneProject)) <SKProductsRequestDelegate>
...
@interface InAppPurchaseManager (SWIFT_EXTENSION(AnimalGestioneProject)) <SKPaymentTransactionObserver>
...
SWIFT_CLASS("_TtC21AnimalGestioneProject21InterstitialAdManager")
...
@interface InterstitialAdManager (SWIFT_EXTENSION(AnimalGestioneProject)) <GADFullScreenContentDelegate>
...
/// 通知管理を担当するシングルトンクラス
SWIFT_CLASS("_TtC21AnimalGestioneProject19NotificationManager")
...
@interface NotificationManager (SWIFT_EXTENSION(AnimalGestioneProject)) <UNUserNotificationCenterDelegate>
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center willPresentNotification:(UNNotification * _Nonnull)notification withCompletionHandler:(void (^ _Nonnull)(UNNotificationPresentationOptions))completionHandler;
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center didReceiveNotificationResponse:(UNNotificationResponse * _Nonnull)response withCompletionHandler:(void (^ _Nonnull)(void))completionHandler;
@end

SWIFT_CLASS_NAMED("PhysiologicalCycleEntity")
@interface PhysiologicalCycleEntity : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@interface PhysiologicalCycleEntity (SWIFT_EXTENSION(AnimalGestioneProject))
...
SWIFT_CLASS("_TtC21AnimalGestioneProject17RewardedAdManager")
@interface RewardedAdManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@interface RewardedAdManager (SWIFT_EXTENSION(AnimalGestioneProject)) <GADFullScreenContentDelegate>
- (void)ad:(id <GADFullScreenPresentingAd> _Nonnull)ad didFailToPresentFullScreenContentWithError:(NSError * _Nonnull)error;
- (void)adDidDismissFullScreenContent:(id <GADFullScreenPresentingAd> _Nonnull)ad;
- (void)adWillPresentFullScreenContent:(id <GADFullScreenPresentingAd> _Nonnull)ad;
- (void)adDidRecordImpression:(id <GADFullScreenPresentingAd> _Nonnull)ad;
